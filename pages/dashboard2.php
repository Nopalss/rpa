...
$_SESSION['halaman'] = 'minmax';
$_SESSION['menu'] = 'minmax';
...
if ($user_id > 0) {
    $stmt_settings = $pdo->prepare("SELECT * FROM tbl_spc_model_settings WHERE user_id = :user_id");
...
?>
    <div class="row mb-7 site-setting-row" data-site="<?= $site_name ?>" id="row_<?= $site_name ?>">
        ...
        <div class="col-xl-2 mb-3 d-flex justify-content-center align-items-center">
            <label class="mr-2 mb-0 small">Min/Max</label>
            <select class="form-control form-control-sm agg-mode" data-site="<?= $site_name ?>" data-field="agg_mode">
                <option value="">Select</option>
        ...
        <div class="col-xl-2 mb-3 d-flex justify-content-center align-items-center">
            <label class="mr-2 mb-0 small">Range</label>
            <input type="number"
                class="form-control form-control-sm col-3 small range-start"
                data-site="<?= $site_name ?>"
                data-field="start_col">
            <span class="pl-2 pr-2">-</span>
            <input type="number"
                class="form-control form-control-sm col-3 small range-end"
                data-site="<?= $site_name ?>"
                data-field="end_col">
        </div>
                ...
                <div class="col-xl-12 mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- ========================= -->
                            <div id="siteTemplate" class="d-none">
                                <?php
                                // index dummy (0), nanti diganti JS
                                renderSiteSettingItem(
                                    0,
                                    '__SITE__',
                                    $lines,
                                    []
