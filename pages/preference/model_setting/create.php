                            ...
                            <div class="card-footer">
                                <div class="text-right">
                                    <?php if (isset($_SESSION['form_add_csv']['application_id'])): ?>
                                        <a onclick="confirmDeleteTemplate('<?= $_SESSION['form_add_csv']['application_id'] ?? '' ?>', 'controllers/preference/delete_temp.php')" class="btn btn-light-danger  btn-safe-navigation">Cancel</a>
                                    <?php else: ?>
