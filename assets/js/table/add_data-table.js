        ...
        datatable = $('#kt_datatable').KTDatatable({
            ...
            columns: [{
                ...
                template: function (row) {
                    return `\
                        <a href="${HOST_URL}pages/data/data_csv.php?file_id=${row.file_id}&application_id=${row.application_id}&line_id=${row.line_id}&date=${row.date}" class="btn btn-sm btn-success btn-text-primary btn-icon mr-2" title="CSV">\
